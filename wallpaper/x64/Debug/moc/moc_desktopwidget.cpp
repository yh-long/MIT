...
#define QT_MOC_LITERAL(ofs, len) \
    uint(sizeof(qt_meta_stringdata_DesktopWidget_t::offsetsAndSizes) + ofs), len 
Q_CONSTINIT static const qt_meta_stringdata_DesktopWidget_t qt_meta_stringdata_DesktopWidget = {
    {
        QT_MOC_LITERAL(0, 13)   // "DesktopWidget"
    },
    "DesktopWidget"
};
...
Q_CONSTINIT static const uint qt_meta_data_DesktopWidget[] = {
...
Q_CONSTINIT const QMetaObject DesktopWidget::staticMetaObject = { {
    ...
    qt_meta_stringdata_DesktopWidget.offsetsAndSizes,
    qt_meta_data_DesktopWidget,
    qt_static_metacall,
    nullptr,
    qt_incomplete_metaTypeArray<qt_meta_stringdata_DesktopWidget_t,
        // Q_OBJECT / Q_GADGET
